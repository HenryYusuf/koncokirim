    ...
    <div class="navbar-header">
                ...
                <a href="index.html" class="logo logo-dark">
                    ...
                    <span class="logo-lg">
                        <img src="{{ asset('backend/assets/images/logo-sm.svg') }}" alt="" height="24"> <span
                            class="logo-txt">Restaurant</span>
                    </span>
                </a>
        ...
        <div class="d-flex">
            ...
            @php
                ...
                $profileData = App\Models\Restaurant::find($id);
            @endphp
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a class="dropdown-item" href="{{ route('restaurant.change.password') }}"><i
                            class="mdi mdi-lock font-size-16 align-middle me-1"></i> Change Password</a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="{{ route('restaurant.logout') }}"><i
