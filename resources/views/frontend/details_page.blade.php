                                                    ...
                                                    <p class="text-gray time mb-0">
                                                        @if ($bestSeller->discount_price == null)
                                                            <a class="btn btn-link btn-sm text-black" href="#">Rp
                                                                {{ number_format($bestSeller->price, 0, ',', '.') }} </a>
                                                        @else
                                                            Rp <del>{{ number_format($bestSeller->price, 0, ',', '.') }}</del>
                                                            <br>
                                                            <a class="mt-1 btn btn-link btn-sm text-black" href="#">Rp
                                                    ...
                                                    <div class="media">
                                                        ...
                                                        <div class="media-body">
                                                            ...
                                                            @if ($product->size == null)
                                                                ...
                                                                @else
                                                                    <p class="text-gray mb-0">Rp {{ number_format($product->discount_price, 0, ',', '.') }}</p>
                                                                @endif
                                                            @else
