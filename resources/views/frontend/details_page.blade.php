...
@section('user')
    ...
    <section class="restaurant-detailed-banner">
        <div class="text-center">
            <img class="img-fluid cover" src="{{ asset('upload/restaurant_images/' . $restaurant->cover_photo) }}">
        </div>
                    ...
                    <div class="col-md-8">
                        <div class="restaurant-detailed-header-left">
                            <img class="img-fluid mr-3 float-left" alt="osahan"
                                src="{{ asset('upload/restaurant_images/' . $restaurant->photo) }}">
                    ...
                    <div class="offer-dedicated-body-left">
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-order-online" role="tabpanel"
                                ...
                                @php
                                    $populars = App\Models\Product::where('status', 1)
                                            ...
                                            <div class="item">
                                                <div class="mall-category-item">
                                                    <a href="#">
                                                        ...
                                                        @else
                                                            Rp <del>{{ number_format($popular->price, 0, ',', '.') }}</del>
                                                            <br>
                                                            Rp {{ number_format($popular->discount_price, 0, ',', '.') }}
                                                        @endif
                                                        <div class="mt-1">
                                                            <a class="btn btn-outline-secondary btn-sm"
                                                                href="{{ route('user.add.to.cart', $popular->id) }}">ADD</a>
                                                        </div>
                                                    </a>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="list-card-body">
                                                        ...
                                                        <p class="text-gray time mb-0">
                                                            ...
                                                            @else
                                                                ...
                                                                <br>
                                                                <a class="mt-1 btn btn-link btn-sm text-black"
                                                                    href="#">Rp
                                                            ...
                                                            <span class="float-right">
                                                                <a class="btn btn-outline-secondary btn-sm"
                                                                    href="{{ route('user.add.to.cart', $bestSeller->id) }}">ADD</a>
                                                            </span>
                                                        </p>
                                                    </div>
                                                </div>
                                ...
                                @foreach ($menus as $menu)
                                    <div class="row">
                                        <h5 class="mb-4 mt-3 col-md-12">{{ $menu->menu_name }} <small
                                                class="h6 text-black-50">{{ $menu->products->count() }}</small>
                                        </h5>
                                        <div class="col-md-12">
                                                        ...
                                                        <div class="media">
                                                            ...
                                                            <div class="media-body">
                                                                ...
                                                                @if ($product->size == null)
                                                                    @if ($product->discount_size == null)
                                                                        <p class="text-gray mb-0">
                                                                            Rp
                                                                            {{ number_format($product->price, 0, ',', '.') }}
                                                                        </p>
                                                                    @else
                                                                        <p class="text-gray mb-0">Rp
                                    ...
                                    <div class="restaurant-slider-main position-relative homepage-great-deals-carousel">
                                        <div class="owl-carousel owl-theme homepage-ad">
                                            ...
                                            @foreach ($galleries as $index => $gallery)
                                                <div class="item">
                                                    <img class="img-fluid" src="{{ asset($gallery->gallery_image) }}">
                                                    <div
                                                        class="position-absolute restaurant-slider-pics bg-dark text-white">
                                                        {{ $index + 1 }} of {{ $galleries->count() }} Photos</div>
                                                </div>
                                            @endforeach
                ...
                <div class="col-md-4">
                    ...
                    <div class="generator-bg rounded shadow-sm mb-4 p-4 osahan-cart-item">
                            ...
                            @if (Session::get('cart'))
                                @foreach (Session::get('cart') as $id => $details)
                                    ...
                                    <div class="gold-members p-2 border-bottom">
                                        <p class="text-gray mb-0 float-right ml-2">Rp
                        ...
                        <div class="mb-2 bg-white rounded p-2 clearfix">
                            ...
                            <h6 class="font-weight-bold text-right mb-2">Subtotal : <span class="text-danger">Rp
