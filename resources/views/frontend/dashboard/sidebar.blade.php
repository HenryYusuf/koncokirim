...
<div class="col-md-3">
    <div class="osahan-account-page-left shadow-sm rounded bg-white h-100">
        ...
        <ul class="nav nav-tabs flex-column border-0 pt-4 pl-4 pb-4" id="myTab" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() === 'change.password' ? 'active' : '' }}" href="{{ route('change.password') }}" role="tab" aria-controls="orders"
                    aria-selected="true"><i class="icofont-food-cart"></i> Change Password</a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() === 'user.all.wishlist' ? 'active' : '' }}" href="{{ route('user.all.wishlist') }}" role="tab" aria-controls="orders"
