            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <h4 class="mb-sm-0 font-size-18">All Pending Restaurant</h4>
        ...
        $(function () {
            $('.toggle-class').change(function () {
                ...
                $.ajax({
                    type: "GET",
                    dataType: "json",
                    url: '/admin/change-status-restaurant',
                    data: { 'status': status, 'restaurant_id': restaurantId },
                    success: function (data) {
                        ...
                        $('#status-text-' + restaurantId).html(statusHtml);
                        // End Message   
